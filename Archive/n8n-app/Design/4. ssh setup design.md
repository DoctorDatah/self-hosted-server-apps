...
| **`SSH_KNOWN_HOSTS_PATH`** | `Apps/n8n-app/ops/ssh/known_hosts` |
...
- **Host key fingerprint:** The VM’s SSH identity stored in `known_hosts`.
...
## Data Design
- **Entities:** `Apps/n8n-app/ops/ssh/known_hosts` for host key fingerprints.
