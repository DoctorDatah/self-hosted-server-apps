...
| **`N8N_IMAGE`** | n8nio/n8n |
| **`N8N_IMAGE_TAG`** | Pinned in `Apps/n8n-app/ops/dependencies.md` (source of truth) |
| **`DB_ENGINE`** | Postgres |
| **`POSTGRES_IMAGE`** | postgres |
| **`POSTGRES_IMAGE_TAG`** | Pinned in `Apps/n8n-app/ops/dependencies.md` (source of truth) |
...
| Pin image tags via `Apps/n8n-app/ops/dependencies.md`. | Deterministic deploys and auditability. | Floating tags. | Manual update process required. |
...
| **Functional** | Source image tags from `Apps/n8n-app/ops/dependencies.md`. |
...
- **Rollback:** Revert tags in `Apps/n8n-app/ops/dependencies.md` and redeploy.
...
## Open Questions
- **Resolved:** Compose files live at `Apps/n8n-app/ops/compose/`.
