...
## Front Matter
- **Title:** Framework Usage Guide (Human-Oriented)
- **Project:** Repo-wide documentation
- **Owner:** Malik
- **Status:** Draft
- **Last updated:** 2026-01-25
- **Related docs:** `AI/1. reading guide for ai and syntax for developer.md`, `AI/2a. design document writing guide.md`, `AI/2b. general document formatting guide.md`, `AI/4. implementation document writing guide.md`
