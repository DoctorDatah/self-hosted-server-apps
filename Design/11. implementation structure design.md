...
| `Design/8. google drive folder and service account setup design.md` | Drive folder and service account setup. |
| `Design/9. github action backup to google drive design.md` | Backup workflow design (Google Drive). |
| `Design/10. restore from google drive design.md` | Restore workflow design (Google Drive). |
| `Design/11. implementation structure design.md` | Repo structure blueprint. |
