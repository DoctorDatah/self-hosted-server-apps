...
## Front Matter
- **Title:** n8n Deployment Design (VM)
- **Project:** n8n self-hosting app
- **Owner:** Malik
- **Status:** Draft
- **Last updated:** 2026-01-25
- **Related docs:** `Design/1. package handling design.md`, `Design/4. ssh setup design.md`, `Design/6.2 gh action deploy script install cloudflare.md`
