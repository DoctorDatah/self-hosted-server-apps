...
## Front Matter
- **Title:** Implementation Structure Design
...
repo-root/
├── AI/
│   ├── 1. reading guide for ai and sytax for devleoper.md
│   ├── 2a. design document writing guide.md
│   └── 2b. design document formatting guide.md
├── Design/
│   ├── 0. scope.md
...
│   └── 9. implementation structure design.md
├── .github/
│   └── workflows/
│       └── deploy.yml
└── ops/
...
| **Path** | **Purpose** |
| --- | --- |
| `AI/1. reading guide for ai and sytax for devleoper.md` | AI reading rules and markers. |
| `AI/2a. design document writing guide.md` | How to write design docs. |
| `AI/2b. design document formatting guide.md` | Formatting rules for design docs. |
...
| `Design/9. implementation structure design.md` | Repo structure blueprint. |
