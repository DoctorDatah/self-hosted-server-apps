...
# USB ISO Downloader for Proxmox
...
DEFAULT_STORAGE_ID="USB-ISO"

require() { command -v "$1" >/dev/null || { echo "ERROR: $1 not found"; exit 1; }; }
require lsblk; require blkid; require mkfs.ext4; require wget; require pvesm
...
read -rp "Proxmox storage ID to use (for pvesm list) [$DEFAULT_STORAGE_ID]: " STORAGE_ID
