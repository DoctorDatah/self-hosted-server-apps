...
## Data Design
- **Entities:** `Apps/n8n-app/requirements/vm_requirements.txt` for host inventory; `Apps/n8n-app/requirements/n8n_container_requirements.txt` for container pins; `Apps/n8n-app/requirements/github_runner_requirements.txt` for runner pins; `Apps/n8n-app/ops/package-audit.md` for audit notes.
