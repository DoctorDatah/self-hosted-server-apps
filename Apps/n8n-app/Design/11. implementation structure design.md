...
└── Apps/
    └── n8n-app/
        ...
        ├── requirements/
        │   ├── vm_requirments.txt
        │   ├── n8n_container_requirments.txt
        │   └── github_runner_requirments.txt
        └── ops/
            ├── cloudflared/
            │   └── config.yml
            ├── compose/
...
| `Apps/n8n-app/requirements/vm_requirments.txt` | Environment-specific pinned host packages for the VM. |
| `Apps/n8n-app/requirements/n8n_container_requirments.txt` | Environment-specific pinned container requirements for n8n. |
| `Apps/n8n-app/requirements/github_runner_requirments.txt` | Environment-specific pinned requirements for the GitHub runner. |
